 ...
 */
// from: sun.nio.fs.AbstractWatchKey
abstract class SunNioFsAbstractWatchKey implements WatchKey {
    ...
    private final SunNioFsAbstractWatchService watcher;
    ...
    protected SunNioFsAbstractWatchKey(Path dir, SunNioFsAbstractWatchService watcher) {
    ...
    final SunNioFsAbstractWatchService watcher() {
        return watcher;
    }
