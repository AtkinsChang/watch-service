 ...
 */
// from: sun.nio.fs.AbstractWatchService
abstract class SunNioFsAbstractWatchService implements WatchService {
    ...
    private final WatchKey CLOSE_KEY =
            new SunNioFsAbstractWatchKey(null, null) {
                @Override
    ...
    protected SunNioFsAbstractWatchService() {
    }
